...
from resoterre.data_management.variables import degree_celsius_units, VariableHandler, VariableHandlerCollection
...
rdps_variables["HU"] = VariableHandler(
    'HU', '1', target_cf_units='1',
    min_value=-0.1, max_value=0.1, mean_min=0.0, mean_max=0.01,  # conservative guess
    clip_min=0, clip_max=None, nan_min=None, nan_max=None,
    cumulative=False, log_normalize=False, normalize_min=0.0, normalize_max=0.02)
...
rdps_variables["PC"] = VariableHandler(
    'PC', 'm', target_cf_units='kg m-2 s-1',
    min_value=-1e-7, max_value=1.0,  # conservative guess for a single point with 2 days accumulation
    mean_min=0.0, mean_max=0.1,  # conservative guess
    clip_min=0, clip_max=None, nan_min=None, nan_max=None,
    cumulative=True, log_normalize=True, normalize_min=0.0, normalize_max=0.001, normalize_log_offset=1e-8)

# pr / precipitation_flux in CF Metadata Conventions
rdps_variables["PR"] = VariableHandler(
    'PR', 'm', target_cf_units='kg m-2 s-1',
    min_value=-1e-7, max_value=5.0,  # conservative guess for a single point with 2 days accumulation
    mean_min=0.0, mean_max=0.1,  # conservative guess
    clip_min=0, clip_max=None, nan_min=None, nan_max=None,
    cumulative=True, log_normalize=True, normalize_min=0.0, normalize_max=0.001, normalize_log_offset=1e-8)
...
rdps_variables["PN"] = VariableHandler(
    'PN', 'mb', target_cf_units='Pa',
    min_value=900.0, max_value=1100.0, mean_min=950.0, mean_max=1050.0,
    clip_min=None, clip_max=None, nan_min=None, nan_max=None,
    cumulative=False, log_normalize=False, normalize_min=900.0, normalize_max=1100.0)
...
rdps_variables["TD"] = VariableHandler(
    'TD', degree_celsius_units, target_cf_units='K',
    min_value=-100.0, max_value=100.0, mean_min=-20.0, mean_max=20.0,
    clip_min=None, clip_max=None, nan_min=None, nan_max=None,
    cumulative=False, log_normalize=False, normalize_min=-40.0, normalize_max=40.0)
...
rdps_variables["TT_model_levels"] = VariableHandler(
    'TT_model_levels', degree_celsius_units, target_cf_units='K',
    min_value=-100.0, max_value=100.0, mean_min=-20.0, mean_max=20.0,  # conservative guess
    clip_min=None, clip_max=None, nan_min=None, nan_max=None,
    cumulative=False, log_normalize=False, normalize_min=-40.0, normalize_max=40.0)
...
rdps_variables["UU_model_levels"] = VariableHandler(
    'UU_model_levels', 'kts', target_cf_units='m s-1',
    min_value=-100.0, max_value=100.0, mean_min=-10.0, mean_max=10.0,
    clip_min=None, clip_max=None, nan_min=None, nan_max=None,
    cumulative=False, log_normalize=False, normalize_min=-100.0, normalize_max=100.0)
...
rdps_variables["VV_model_levels"] = VariableHandler(
    'VV_model_levels', 'kts', target_cf_units='m s-1',
    min_value=-100.0, max_value=100.0, mean_min=-10.0, mean_max=10.0,
    clip_min=None, clip_max=None, nan_min=None, nan_max=None,
    cumulative=False, log_normalize=False, normalize_min=-100.0, normalize_max=100.0)
...
rdps_variables["GZ"] = VariableHandler(
    'GZ', 'dam',  # decameter, 4 pressure levels
    min_value=50.0, max_value=1500.0, mean_min=250.0, mean_max=1000.0,
    clip_min=None, clip_max=None, nan_min=None, nan_max=None,
    cumulative=False, log_normalize=False, normalize_min=50.0, normalize_max=1500.0)
for vertical_level in vertical_levels:
