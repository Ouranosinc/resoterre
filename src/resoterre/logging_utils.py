...
def default_basic_config_args(basic_config_args: dict[str, str | int | bool], show_logger_name: bool = False,
                              show_date: bool = True) -> dict:
    """
    Create a default set of basicConfig arguments for logging.

    Parameters
    ----------
    basic_config_args : dict[str, str | int | bool]
...
def start_root_logger(
    basic_config_args: dict[str, object] | None = None,
